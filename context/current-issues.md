...
- the shapes are not exactly like the options we are only getting rectangle fix the actual visual of shapes
- we can't adjust the size of the shapes by holding and moving their sides i want you to fix that functionality 
